...
class Statki {
	...
	pokazObiePlansze(): void {
		console.log(`\n____Plansze po turze____`);
		console.log(`${this.aktualnyGracz.nazwa} - Plansza ataków:`);
		this.aktualnyGracz.pokazPlanszeAtaku();
		console.log(`${this.aktualnyGracz.nazwa} - Plansza:`);
		this.przeciwnik.pokazPlansze();
		console.log(`\n________________\n`)
	}
